...
import com.chaofan.common.utils.DateUtils;
import com.chaofan.common.utils.Result;
import com.chaofan.common.utils.Status;
import com.chaofan.common.utils.UploaderMessage;
import com.chaofan.config.redis.CacheService;
...
public class AccountController {
	...
	@RequestMapping(value = "member/wallet.html", method = RequestMethod.GET)
	public ModelAndView wallet(ModelAndView model , HttpSession session){
		model.setViewName("member/wallet");
		MemberEntity member = (MemberEntity) session.getAttribute("currMember");
		model.addObject("member" , memberService.findByUid(member.getId()));
		return model;
	}
