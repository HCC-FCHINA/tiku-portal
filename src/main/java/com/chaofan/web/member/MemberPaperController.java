...
import com.chaofan.common.utils.ExceptionSupport;
...
public class MemberPaperController {
	...
	@ResponseBody
	public Map<String, Object> paperList( Integer page , Integer limit , HttpSession session){
		MemberEntity member = ((MemberEntity)session.getAttribute("currMember"));
		Page<PaperEntity> list = iPaperService.selectPage(new Page<>(page , limit) , Condition.create().eq("creater_id", member.getId()));
