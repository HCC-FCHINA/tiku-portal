			...
			success : function(data) {// 返回数据根据结果进行相应的处理,无论请求成功还是失败，都会走这个方法的
				...
				if(data != null){
					for(var i=0 ; i<data.length ; i++){
						...
						html += '<a class="list-item-link list-item-link-jiexi" data-paperid="d08fb966f5335a8102d220a5" href="/tikupc/paperdetail/d08fb966f5335a8102d220a5?showan=1" >解析</a><span class="item-separate">|</span>';
						html += '<a "=" " class=" list-item-link  list-item-link-xiazai" data-paperid="d08fb966f5335a8102d220a5 " href="/tikupc/paperdetail/d08fb966f5335a8102d220a5" >下载</a><span class="item-separate ">|</span><a class="list-item-link list-item-link-gufen " data-paperid="d08fb966f5335a8102d220a5 " href="/gaokaogufen/paperdetail/d08fb966f5335a8102d220a5 ">估分</a></p>';
						html += '</li>';
					}
				}
